...
class LiveRealmResults<T : RealmModel> @MainThread
constructor(@param:NonNull private val results: RealmResults<T>) : LiveData<List<T>>() {
    ...
    private val listener = OrderedRealmCollectionChangeListener<RealmResults<T>> { results, changeSet ->
